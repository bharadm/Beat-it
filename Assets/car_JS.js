...
wheelPos = hit.point+wheelFL.transform.up * (wheelFL.radius/2);
}
else {
...
wheelPos = hit.point + wheelFR.transform.up * (wheelFR.radius/2);
}
else {
...
wheelPos = hit.point+wheelRL.transform.up * (wheelRL.radius/2);
}
else {
...
wheelPos = hit.point+wheelRR.transform.up * (wheelRR.radius/2);
}
else {
